  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8 max-w-6xl">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Create Your Trip</h1>
        <p className="text-gray-600 text-sm sm:text-base px-4">First, add the destinations you want to visit and your travel dates.</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Travel Dates</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-base sm:text-lg"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={!startDate}
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed text-base sm:text-lg"
            />
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        {destinations.length > 0 && (
          <div>
            <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-4">Your Destinations</h3>
            <div className="space-y-3">
              {destinations.map((destination, index) => (
                <div 
                  key={destination.id}
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-lg gap-3 sm:gap-4"
                >
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="font-bold text-gray-900 text-base sm:text-lg block truncate">{destination.name}</span>
                      {destination.country && (
                  ...
                  {/* Days to Stay Input and Remove Button */}
                  <div className="flex items-center justify-between sm:justify-end gap-3">
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <input
                        ...
                        className="w-16 sm:w-20 px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-teal-500 focus:border-transparent font-medium text-sm sm:text-base"
                      />
                    </div>
        ...
        {destinations.length === 0 && (
          <div className="text-center py-6 sm:py-8 text-gray-500">
            <p className="text-sm sm:text-base">Add your first destination to get started</p>
          </div>
        )}
      </div>
      ...
      <div className="text-center">
        <button
          ...
          disabled={!canProceed}
          className={`w-full py-3 sm:py-4 px-6 rounded-lg font-semibold text-lg sm:text-xl transition-colors ${
            canProceed
