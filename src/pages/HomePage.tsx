...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section - Updated with teal theme */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Subtle background gradient with teal */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-teal-50/30"></div>
        
        {/* Floating geometric shapes - updated with teal colors */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-teal-100/20 to-blue-100/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-blue-100/20 to-teal-100/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '12s', animationDelay: '2s' }}></div>
        </div>
        ...
        <div className="container mx-auto px-4 z-10 text-center max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <button 
              ...
              className="group relative bg-gradient-to-r from-teal-500 to-teal-600 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:from-teal-600 hover:to-teal-700 hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          {/* Trust indicators - updated with teal accents */}
      ...
      {/* How It Works Section - Updated with teal theme */}
      ...
      {/* Features Section - Updated with teal theme */}
      <section className="py-32 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Feature 2 - Updated with teal theme */}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mt-16">
              ...
              <div className="text-center">
                <div className="text-4xl font-light text-teal-600 mb-2">24/7</div>
      ...
      {/* Final CTA Section - Updated with teal theme */}
      <section className="py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          {/* Trust signals - minimal with teal accents */}
