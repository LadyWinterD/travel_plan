        ...
        >
          ...
          {showCorrection && (
            <button
              ...
              className={`w-full px-4 py-3 text-left hover:bg-blue-50 focus:bg-blue-50 focus:outline-none transition-colors border-b border-gray-100 ${
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium">Did you mean "{correctedValue}"?</div>
                  <div className="text-sm text-blue-500">Auto-correction suggestion</div>
                </div>
              </div>
            </button>
          )}
