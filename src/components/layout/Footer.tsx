          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12 lg:flex-1">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/about" className="text-gray-300 hover:text-teal-400 transition-colors text-base sm:text-lg hover:underline">
                    About
                  </Link>
                </li>
                <li>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3">
                <li>
                  <Link 
                    to="/privacy-policy" 
                    className="text-gray-300 hover:text-teal-400 transition-colors text-base sm:text-lg hover:underline"
